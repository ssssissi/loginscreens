...
class FTMM extends StatefulWidget {
  const FTMM({Key? key}) : super(key: key);

  @override
  _FTMMState createState() => _FTMMState();
}
class _FTMMState extends State<FTMM> {
  getMethod() async{
    String theUrl = "https://flutterperform.000webhostapp.com/1Mont.php";
                ...
                Row(
                  ...
                  children:[
                    ...
                    ElevatedButton(
                        onPressed: (){
                          Navigator.push(context,
                              MaterialPageRoute(builder: (context) => const TTMM()));
                        },
                        style: ElevatedButton.styleFrom(
                            primary: const Color(0xff051b47),
                            fixedSize: const Size(120, 60),
