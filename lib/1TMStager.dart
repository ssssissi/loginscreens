...
class FTMS extends StatefulWidget {
  const FTMS({Key? key}) : super(key: key);

  @override
  _FTMSState createState() => _FTMSState();
}
class _FTMSState extends State<FTMS> {
  getMethod() async{
    String theUrl = "https://flutterperform.000webhostapp.com/1Stager.php";
          ...
          Column(
              children: [
                ...
                Row(
                  ...
                  children:[
                    ElevatedButton(
                        onPressed: (){ Navigator.push(context, MaterialPageRoute(builder:(context) => const STMS()));},
