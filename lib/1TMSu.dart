...
import '2TMSu.dart';
import 'DB/3TMSu.dart';
import 'KYCSurbeck.dart';
import 'calendar.dart';


class FTMSu extends StatefulWidget {
  const FTMSu({Key? key}) : super(key: key);

  @override
  _FTMSuState createState() => _FTMSuState();
}
class _FTMSuState extends State<FTMSu> {
  getMethod() async{
    String theUrl = "https://flutterperform.000webhostapp.com/1Surbeck.php";
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          title: const Text('1st Month Activity', style: TextStyle(color: Colors.white)),
          content: SingleChildScrollView(
            child: ListBody(
              children: [
                const Text('Visualisation of the first month trading activity.',
                ...
                Image.asset(
                  'assets/images/TM1Su1.png',
                  alignment: Alignment.centerLeft,
                  fit: BoxFit.fill,
                ),
                const SizedBox(height: 10),
                const Text('Portfolio 2',
                    textAlign: TextAlign.center,
                    style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold,fontSize: 18)),
                const SizedBox(height: 10),
                Image.asset(
                  'assets/images/TM1Su2.png',
                  alignment: Alignment.center,
                  height: 200,
                  width: 400,
                ),
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            ...
                            const Text("First Trading Month Activity",
                              textAlign: TextAlign.center,
                              style: TextStyle(
                                  fontSize: 22,
                                  letterSpacing:2,
                            ...
                            Column(
                              ...
                              children: <Widget>[
                                ...
                                Text("Security ID: ${snap[index]['securityID']}",
                                    style: const TextStyle(
                                        fontSize: 20,
                                        letterSpacing:1,
                                        color: Colors.white60
                                    )),
                                Text("Transaction Date: ${snap[index]['dateOfTran']}",
                                    style: const TextStyle(
                                        fontSize: 20,
                                        letterSpacing:1,
                                        color: Colors.white60
                                    )),
                                Text("Type of Transaction: ${snap[index]['typeOfTran']}",
                                    style: const TextStyle(
                                        fontSize: 20,
                                        letterSpacing:1,
                                        color: Colors.white60
                                    )),
                                Text("Security Amount: ${snap[index]['securityAmount1']}",
                                    style: const TextStyle(
                                        fontSize: 20,
                                        letterSpacing:1,
                                        color: Colors.white60
                                ...
                                Text("Short Description: ${snap[index]['companyDescr']}",
                                    style: const TextStyle(
                                        fontSize: 20,
                                        letterSpacing:1,
                                        color: Colors.white60
              ...
              children: [
                ...
                Row(
                  ...
                  children:[
                    ElevatedButton(
                        onPressed: (){
                          Navigator.push(context,
                              MaterialPageRoute(builder: (context) => const STMSu()));
                        },
                    ...
                    ElevatedButton(
                        onPressed: (){
                          Navigator.push(context, MaterialPageRoute(builder:(context) => const TTMSu()));
                        },
                        style: ElevatedButton.styleFrom(
                            primary: const Color(0xff051b47),
                            fixedSize: const Size(120, 60),
                    ...
                    ElevatedButton(
                        onPressed: (){
                          Navigator.push(context, MaterialPageRoute(builder:(context) => const KYCSu()));
                        },
                        style: ElevatedButton.styleFrom(
                            primary: const Color(0xff051b47),
                            fixedSize: const Size(120, 60),
