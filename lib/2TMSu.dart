...
import 'package:untitled/1TMSu.dart';
...
class STMSu extends StatefulWidget {
  const STMSu({Key? key}) : super(key: key);

  @override
  _STMSuState createState() => _STMSuState();
}
class _STMSuState extends State<STMSu> {
  getMethod() async{
    String theUrl = "https://flutterperform.000webhostapp.com/2Surbeck.php";
              ...
              children: [
                ...
                Row(
                  ...
                  children:[
                    ElevatedButton(
                        onPressed: (){
                          Navigator.push(context, MaterialPageRoute(builder:(context) => const FTMSu()));
                        },
