...
class TTMM extends StatefulWidget {
  const TTMM({Key? key}) : super(key: key);

  @override
  _TTMMState createState() => _TTMMState();
}
class _TTMMState extends State<TTMM> {
  getMethod() async{
    String theUrl = "https://flutterperform.000webhostapp.com/3Mont.php";
              ...
              children: [
                ...
                Row(
                  ...
                  children:[
                    ElevatedButton(
                        onPressed: (){
                          Navigator.push(context, MaterialPageRoute(builder:(context) => const FTMM()));
                        },
                    ...
                    ElevatedButton(
                        onPressed: (){
                          Navigator.push(context, MaterialPageRoute(builder:(context) => const STMM()));
                        },
                        style: ElevatedButton.styleFrom(
                            primary: const Color(0xff051b47),
                            fixedSize: const Size(120, 60),
