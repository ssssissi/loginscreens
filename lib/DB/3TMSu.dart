...
import 'package:untitled/KYCSurbeck.dart';
...
class TTMSu extends StatefulWidget {
  const TTMSu({Key? key}) : super(key: key);

  @override
  _TTMSuState createState() => _TTMSuState();
}
class _TTMSuState extends State<TTMSu> {
  getMethod() async{
    String theUrl = "https://flutterperform.000webhostapp.com/3Surbeck.php";
              ...
              children: [
                ...
                Row(
                  ...
                  children:[
                    ...
                    ElevatedButton(
                        onPressed: (){
                          Navigator.push(context, MaterialPageRoute(builder:(context) => const STMSu()));
                        },
                        style: ElevatedButton.styleFrom(
                            primary: const Color(0xff051b47),
                            fixedSize: const Size(120, 60),
