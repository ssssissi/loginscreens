...
class KYCM extends StatefulWidget {
  const KYCM({Key? key}) : super(key: key);

  @override
  _KYCMState createState() => _KYCMState();
}
class _KYCMState extends State<KYCM> {
  getMethod() async{
    String theUrl = "https://flutterperform.000webhostapp.com/KYCMont.php";
