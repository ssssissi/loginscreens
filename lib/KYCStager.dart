...
import 'dart:convert';
import 'dart:core';
import 'package:untitled/StagerPort.dart';
import 'package:untitled/profile_page.dart';
import 'package:untitled/settings.dart';
import 'package:untitled/stocks.dart';

import 'StagerTrading.dart';
import 'calendar.dart';

class KYCS extends StatefulWidget {
  const KYCS({Key? key}) : super(key: key);

  @override
  _KYCSState createState() => _KYCSState();
}
class _KYCSState extends State<KYCS> {
  getMethod() async{
    String theUrl = "https://flutterperform.000webhostapp.com/KYCStager.php";
