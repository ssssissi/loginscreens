...
import 'StagerPort.dart';
import 'calendar.dart';


class Stager extends StatefulWidget {
  const Stager({Key? key}) : super(key: key);

  @override
  _StagerState createState() => _StagerState();
}
class _StagerState extends State<Stager> {
  getMethod() async{
    String theUrl = "https://flutterperform.000webhostapp.com/Stager.php";
                  ...
                  children:[
                    ElevatedButton(
                        onPressed: (){
                          Navigator.push(context,
                              MaterialPageRoute(builder: (context) => const StagerPort()));
                        },
                    ...
                    ElevatedButton(
                        onPressed: () {  Navigator.push(context,
                            MaterialPageRoute(builder: (context) => const StagerTrading())); },
                        style: ElevatedButton.styleFrom(
                            primary: const Color(0xff051b47),
                            fixedSize: const Size(120, 60),
                            side: const BorderSide(width: 1.5, color: Colors.white),
