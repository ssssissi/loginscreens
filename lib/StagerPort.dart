...
class StagerPort extends StatefulWidget {
  const StagerPort({Key? key}) : super(key: key);

  @override
  _StagerPortState createState() => _StagerPortState();
}
class _StagerPortState extends State<StagerPort> {
  getMethod() async{
    String theUrl = "https://flutterperform.000webhostapp.com/StagerPort.php";
