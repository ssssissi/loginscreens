...
import 'package:untitled/2TMS.dart';
...
class StagerTrading extends StatefulWidget {
  const StagerTrading({Key? key}) : super(key: key);

  @override
  _StagerTradingState createState() => _StagerTradingState();
}
class _StagerTradingState extends State<StagerTrading> {
  void _showcontent() {
    showDialog(
                                      ...
                                      child: IconButton(
                                          ...
                                          onPressed: ()  {
                                            Navigator.push(context,
                                              MaterialPageRoute(builder: (context) => const FTMS()),
                                            );
                                          },
                                          icon: const Icon(
                                            Icons.all_inbox,
