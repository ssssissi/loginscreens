...
class Surbeck extends StatefulWidget {
  const Surbeck({Key? key}) : super(key: key);

  @override
  _SurbeckState createState() => _SurbeckState();
}
class _SurbeckState extends State<Surbeck> {
  getMethod() async{
    String theUrl = "https://flutterperform.000webhostapp.com/Surbeck.php";
