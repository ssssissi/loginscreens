...
import 'package:untitled/StagerTrading.dart';
...
import 'SurbeckTrading.dart';
import 'calendar.dart';


class SurbeckPort extends StatefulWidget {
  const SurbeckPort({Key? key}) : super(key: key);

  @override
  _SurbeckPortState createState() => _SurbeckPortState();
}
class _SurbeckPortState extends State<SurbeckPort> {
  getMethod() async{
    String theUrl = "https://flutterperform.000webhostapp.com/SurbeckPort.php";
