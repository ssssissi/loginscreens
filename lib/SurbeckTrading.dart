...
class SurbeckTrading extends StatefulWidget {
  const SurbeckTrading({Key? key}) : super(key: key);

  @override
  _SurbeckTradingState createState() => _SurbeckTradingState();
}
class _SurbeckTradingState extends State<SurbeckTrading> {
  void _showcontent() {
    showDialog(
                                      ...
                                      child: IconButton(
                                          ...
                                          onPressed: ()  {
                                            Navigator.push(context,
                                              MaterialPageRoute(builder: (context) => const FTMSu()),
                                            );
                                          },
                                          icon: const Icon(
                                            Icons.all_inbox,
